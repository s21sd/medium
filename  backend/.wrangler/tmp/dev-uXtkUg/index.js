  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\LENOVO\\Desktop\\medium\\ backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\LENOVO\\Desktop\\medium\\ backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-bwGMne/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-bwGMne/middleware-insertion-facade.js
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  const token = await sign2({ id: user.id }, c.env.JET_SECRET);
  return c.json({
    jwt: token
  });
});
userRouter.post("/signin", async (c) => {
  ...
  const jwt2 = await sign2({ id: user.id }, c.env.JET_SECRET);
  return c.json({
    jwt: jwt2
  });
});
...
blogRouter.use("/*", async (c, next) => {
  ...
  const user = await verify2(header, c.env.JET_SECRET);
  if (user) {
